...
export class Register extends Component {
  ...
  sentUserToServer = (e) => {
    ...
    axios.post('http://localhost:3001/register',{
      ...
      console.log(response.data) // response.data server side'da yazdigim specific mesaji ifade ediyor.
             ...
             <div className="wrap-login100">
               ...
               <div className="login100-form validate-form">
                 ...
                 <div className="container-login100-form-btn">
                   <button onClick={this.sentUserToServer} className="login100-form-btn">
                     Register
                   </button>
